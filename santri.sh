...
echo $i" |"$cy" BREBES CYBER SANTREE ERROR NOT FOUND"                  "$i"["$bi"       "|"
echo $i" |"$me"─────────────────────────────────────────────"        $i"|"
echo $i" |"$pu" AUTHOR   :"$ku" ENANKS GAGAL NYANTRI  [PEMULUNG]"      $i"|"
echo $i" |"$pu" FACEBOOK :"$ku" Galank Rambu Anarki"                    $i"|"
echo $i" |"$pu" THANKS TO:"$cy"~ [MR.ONTA] [MR.TITIT] [MR.NDOG]"     $i"|"
echo $i" |"$cy"                 ~ [cyber] [MR.BOKEP] [MR.BAWANG]"          $i"|"
echo $i" |"$pu" WATSAPP  :"$ku" 0895704312623"                $i"|"
echo $i" |"$pu" EMAIL    :"$ku" mulyadiahmad118@gmail.com"   $i"|"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
echo $i"|"$me" 1"$i" |"$cy" BRUTEFORCE FB PHP        "$i"|"$i"    |"$cy" B"$i" |"
echo $i"|"$me" 2"$i" |"$cy" BRUTEFORCE FB CENDOL     "$i"|"$i"    |"$cy" E"$i" |"
echo $i"|"$me" 3"$i" |"$cy" BRUTEFORCE FB TITIT      "$i"|"$i"    |"$cy" N"$i" |"
...
echo $i"────────────────────────────────"$i"    |"$cy" R"$i" |"
echo $i"|"$me"18"$i" |"$cy" INSTALL BAHAN NDISIT OH BRO  "$i"|"$i"|"$cy" E"$i" |"
echo $i"|"$me"19"$i" |"$cy" KELUAR/EXIT PROGRAM      "$i"|"$i"    |"$cy" N"$i" |"
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"LIMBANGAN CYBER CRIME"$bi"]"$me"======"$bi"["$i""Pilih Nomore bosqu""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
pkg install nano
figlet -f slant " S U K S E S BRO "|lolcat
fi
...
sleep 2
echo $cy"Terima Kasih ws ngenggo Tool kie"
sleep 2
echo $i"Nari ana kesalahan silakan hubungi kontak ng ngingsor"
sleep 2
echo $ku"WhatsApp :"$i" 0895704312623"
echo $ku"Facebook :"$i" Galank Rambu Anarki"
sleep 2
